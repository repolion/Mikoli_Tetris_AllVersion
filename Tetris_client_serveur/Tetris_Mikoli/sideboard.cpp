...
void SideBoard::setDisplay(){
    ...
    //    QString unreachableQ = "Server unreachable...";
    //    QString waitingQ = "Waiting for a player...";
    ...
    //Affichage "Serveur injoignable"
    //    if(this->_isUnreachable){
    //        SideBoard::displayLabel(unreachableQ,15,3,20,Qt::red,20);
    //    }

    //Affichage "attente d'un autre joueur"
    //    if(this->_isWaiting){
    //        SideBoard::displayLabel(waitingQ,15,4,20,Qt::red,20);
    //    }
