...
#include <list>
#include <vector>
#include "observer/observablewidget.h"
...
public:
    ...
    /*!
     * \brief isSinglePlayer
     * \return True if it's a single player game, false otherwise.
     */
    bool isSinglePlayer();

    /*!
     * \brief checkIfIsBlocked
     * \return True if the current figure can go lower, false otherwise.
     */
